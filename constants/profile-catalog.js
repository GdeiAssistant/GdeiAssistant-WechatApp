...
function getLabels(locale) {
  const currentLocale = typeof i18n.getCurrentLocale === 'function' ? i18n.getCurrentLocale() : 'zh-CN'
  const normalizedLocale = normalizeLocale(locale || currentLocale)
...
module.exports = {
  buildDefaultProfileOptionsPayload: buildDefaultProfileOptionsPayload,
  getLabels: getLabels
}
